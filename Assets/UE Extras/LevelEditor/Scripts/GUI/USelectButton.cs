...
namespace Ultra.LevelEditor
{
	...
	public class USelectButton : UltraGUI, IPointerDownHandler, IPointerUpHandler, IPointerExitHandler, IPointerEnterHandler, ISubmitHandler
	{
        public enum SelectedStates { Selected, UnSelected }

        [Header("Select Button")]
        [MMReadOnly] public SelectedStates SelectedState = SelectedStates.UnSelected;
		...
		public virtual void OnPointerDown(PointerEventData data)
		{
            ...
            GUIManager.UpdateSelectButton(this);
        }
        public virtual void Select()
		{
            SelectedState = SelectedStates.Selected;
		...
		{
            SelectedState = SelectedStates.UnSelected;

            _lastColor = UnSelectedColor;
